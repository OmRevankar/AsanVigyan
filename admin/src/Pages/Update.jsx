      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
          <div className="bg-slate-900 p-8 text-center relative">
            <h1 className="text-white text-2xl font-black uppercase tracking-tight">Edit Credentials</h1>
            <p className="text-slate-400 text-xs font-medium mt-1">Update your administrative identity</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-8 md:p-12 space-y-8">
            ...
            <div className="flex flex-col items-center">
              <div className="relative group">
                <div className="size-32 rounded-[2rem] overflow-hidden border-4 border-slate-50 shadow-inner bg-slate-100">
                  {previewImage ? (
              ...
              <p className="mt-3 text-[10px] font-black text-slate-400 uppercase tracking-widest">Click photo to change</p>
            </div>
            ...
            >
              {isSubmitting ? "Processing..." : <><Save size={20} /> Update Admin Account</>}
            </button>
          </form>
        </div>
      </main>
